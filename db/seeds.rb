...
Template.create("name"=>"confession bear", "image" => URI.escape("http://i.imgur.com/uGNb9El.jpg"), :user => user, :id => 1)
...
Template.create("name"=>"scumbag steve", "image" => URI.escape("http://i.imgur.com/b9IWEug.jpg"), :user => user, :id => 11)
